            ...
            <form @submit.prevent>
                ...
                <div v-if="step === -1" class="step-content text-center">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <Link
                            :href="route('diagnostic.index', { type: type === 'pf' ? 'pj' : 'pf' })"
                ...
                <div v-else-if="step === questions.length && !submitted" class="step-content">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <p v-if="form.lead.email && !isEmailValid" class="text-red-500 text-xs mt-1 ml-2 font-bold">Insira um e-mail válido.</p>
                        </div>
                        ...
                        <div class="captcha-placeholder">
                            ...
                            <span class="text-xs text-slate-400 font-bold uppercase tracking-widest">Proteção Ativa</span>
                        </div>
                    </div>
